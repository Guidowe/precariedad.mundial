...
A continuación se presentan ejemplos de usos para el procesamiento de los datos y elaboración de gráficos. Parte de estos resultados fueron presentados por nuestro grupo de trabajo (para verlos hacer [click aquí](https://www.unse.edu.ar/trabajoysociedad/38%20GRANA%20ET%20ALT%20La%20calidad%20del%20empleo%20en%20la%20Argentina.pdf) o [aquí](https://doi.org/10.15446/ede.v32n61.100343)).

## Estructura del empleo en el sector privado

El dataframe permite caracterizar la estructura del mercado de trabajo según la información sobre categoría ocupacional en la variable en ```CATOCUP``` (Cuentapropista, Patrón y Asalariado/a), el tamaño del establecimiento productivo en ```TAMA``` (Pequeño, Mediano o Grande) y la complejidad en la calificación del puesto en la variable ```CALIF``` (Alta, Mediana, Baja). Vamos analizar ahora la estructura del mercado de trabajo para la fuerza de trabajo asalariada o cuenta propista del sector privado para todos los países del dataset utilizando estas variables.
...
El dataframe de **precariedad.mundial** tiene información sobre expresiones de precariedad laboral en términos de registración de la relación laboral, empleo temporario y empleo part-time involuntario. Para analizar la incidencia de éstas sobre la población asalariada se recomienda filtrar el dataframe con la fuerza de trabajo asalariada y eliminar casos no válidos para las variables de precariedad.
...
Luego calculamos la incidencia de las expresiones de precariedad por pais.
...
Por último graficamos la incidencia de las expresiones de precariedad por pais para cada uno de los 9 perfiles.
