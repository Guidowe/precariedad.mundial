...
La base de datos homogeneizada de *precariedad.mundial* simplifica la comparación entre países para un conjunto de indicadores sociolaborales. Para procesar la base de datos primero se debe abrir `base_homogenea.RDS` como dataframe.
...
```
Por último graficamos información para todos los países del set incluidos en **precariedad.mundial**
