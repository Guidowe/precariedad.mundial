...
distrib.grupos<- base.unica %>% 
  ...
  group_by(Pais) %>% 
  mutate(Distrib = formato_porc(ocupados.pond/sum(ocupados.pond)*100)) 
...
```
##Precariedad
En cuanto a calidad del vínculo en USA no hay información como la que buscabamos en esta encuesta (raro). De las 3 alternativas que propusimos solo se puede construir la de full o part time, y hay asociada una pregunta de porqué en caso de part time. No me metí a construir eso x ahora.
